...
if (isset($_POST['update'])) {
    ...
    $q = "UPDATE `books` SET `title`='$update_title',`author`='$update_author',`description`='$update_description',`publisher`='$update_publisher',`isbn`='$update_isbn',`category_id`='$update_category' WHERE `id` = $id";
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="update_title" class="form-control" id="update_title" value="<?php echo $fetch_books['title'] ?>" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="update_author" class="form-control" id="update_publisher" value="<?php echo $fetch_books['author'] ?>" readonly>
