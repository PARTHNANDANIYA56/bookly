...
if (isset($_POST['add_book'])) {
    ...
    $add_book_query = mysqli_query($conn, "INSERT INTO `books`(`title`, `author`,`author_id`,`description`, `publisher`, `isbn`, `category_id`, `cover`, `file`, `shows`,`status`) VALUES ('$title','$author','$author_id','$description','$publisher','$isbn','$category','$cover','$file','$shows','$status')") or die('query failed');
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-6">
                                        ...
                                        <input type="text" name="book_author" value="<?php echo $_SESSION['author_name'] ?>" class="form-control" id="book_author" readonly>
                                ...
                                <input type="hidden" value="<?php echo $_SESSION['author_id'] ?>" name="author_id" id="author_id">
                            ...
                            <table id="example" class="table table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    <form action="" method="post">
                                        <?php
                                        $name = $_SESSION['author_id'];
                                        $select_book = mysqli_query($conn, "SELECT * FROM `books` where `author_id` = '$name' ") or die('query failed');
