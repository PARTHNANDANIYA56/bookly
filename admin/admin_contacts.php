                  ...
                  <div class="modal-content">
                     ...
                     <form method="POST" action="">
                        <div class="modal-body">
                           ...
                           <input type="hidden" value="<?php echo $_SESSION['admin_name'] ?>" name="editor">
                        ...
                        <table id="acategory" class="table table-bordered" style="width:100%">
                           ...
                           <tbody>
                              <form action="" method="post">
                                 <?php
                                 $select_category = mysqli_query($conn, "SELECT * FROM `message`") or die('query failed');
                                 if (mysqli_num_rows($select_category) > 0) {
                                 ...
                                 ?>
                                       ...
                                       <tr>
                                          ...
                                          <td><?php echo $fetch_category['number'] ?></td>
                                          <td><?php echo $fetch_category['message'] ?></td>
                                          <td>
                                             ...
                                             <div class="">
                                                ...
                                                <button class="btn btn-danger confirm_btn" onclick="deleteMessage(<?php echo $fetch_category['id']; ?>)"><i class="fa-solid fa-trash" style="color: #ffffff;"></i></button>
                                             </div>
                                          </td>
