...
<div class="main">
    ...
    <main class="content">
        <div class="container-fluid p-0">
            ...
            <h1 class="h3 mb-3"><strong>Authors</strong> </h1>
            <div class="row">
                            ...
                            <div class="row" id="example1">
                                ...
                                <table id="users" class="table table-bordered" style="width:100%">
                                    ...
                                    <tbody>
                                        <form action="" method="post">
                                            <?php
                                            $select_users = mysqli_query($conn, "SELECT * FROM `users` where user_type = 'author'") or die('query failed');
                                            if (mysqli_num_rows($select_users) > 0) {
                                                while ($fetch_user = mysqli_fetch_assoc($select_users)) {
                                                    $uname = $fetch_user['name'];
                                                    $r_category = mysqli_query($conn, "SELECT * FROM `category` where editor = '$uname'");
                                                    $count_category = mysqli_num_rows($r_category);
                                            ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="">
                                                                ...
                                                                <!-- <a href="update_author.php?uid=<?php echo $fetch_user['id'] ?>">
